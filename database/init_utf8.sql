...
VALUES ('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZRGdjGj/n3.iW8jY9D6aV3xV9xKCe', 'System Administrator', 'admin', 'active');

-- 插入默认部门
INSERT INTO dept (name, responsible_types) VALUES 
('Municipal Management', ARRAY['Road Damage', 'Manhole Cover Missing', 'Street Light Fault']),
('Traffic Management', ARRAY['Traffic Signal', 'Road Congestion', 'Illegal Parking']),
('Landscaping', ARRAY['Tree Fall', 'Greening Missing', 'Park Facilities']),
('Environmental Sanitation', ARRAY['Garbage Accumulation', 'Sewage Overflow', 'Dust Pollution']);

-- 插入系统配置
INSERT INTO system_config (config_key, config_value, description) VALUES
('map_center_lng', '114.935', 'Map center longitude'),
('map_center_lat', '25.845', 'Map center latitude'),
('map_zoom', '12', 'Default map zoom level'),
('point_rule_report', '10', 'Report event point reward'),
('point_rule_diary', '5', 'Publish diary point reward'),
('point_rule_like', '1', 'Get like point reward');

-- 插入AI知识库示例
INSERT INTO ai_knowledge (category, question, answer, keywords) VALUES
('Cycling Safety', 'What should I pay attention to when cycling?', 'When cycling, please note: 1. Wear a safety helmet; 2. Obey traffic rules; 3. Maintain a safe distance; 4. Pay attention to road changes; 5. Turn on lights at night.', ARRAY['safety', 'attention', 'cycling']),
('Route Planning', 'How to plan a cycling route?', 'You can plan routes through: 1. Click start and end points on the map; 2. Use the search box to input place names; 3. Use voice command "Xiaoqian, help me plan a route from XX to XX". The system supports five modes: fastest, shortest, safest, scenic, and red research.', ARRAY['route', 'planning', 'navigation']),
('Red Spots', 'What red spots are there in Ganzhou?', 'Ganzhou is a famous red revolutionary base area. Main red spots include: Ruijin Republic Cradle Scenic Area, Yudu Long March Departure Site, Xingguo General Park, Ningdu Uprising Memorial Hall, etc. You can choose the red research route, and the system will automatically connect related spots and provide explanations.', ARRAY['red', 'spots', 'revolution']);
